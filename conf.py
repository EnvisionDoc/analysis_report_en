...
project = u'EnOS EnOS Analytics and Report'
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'EnOS Analytics and Report',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Analytics and Report',
     [author], 1)
]
